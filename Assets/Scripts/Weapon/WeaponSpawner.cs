...
public abstract class WeaponSpawner : MonoBehaviour
{
    ...
    protected void Initialize()
    {
        ...
        if (weaponData.GetWeaponType().ToString() == "Whip" &&
            Player.GetInstance().GetCharacterType().ToString() == "Rouge")
        {
    ...
    {
        if(weaponData.GetWeaponType().ToString() == "Lightning" && Player.GetInstance().GetCharacterType().ToString() == "ThunderLord")
            finalAttackSpeed = attackSpeed * 0.5f;
        else
